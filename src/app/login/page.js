...
export default function LoginPage() {
    ...
    return <div className={"flex max-w-md mx-auto w-full flex-col gap-5"}>
        ...
        <button className={"bg-amber-500 text-black px-3 py-2 rounded-md hover:opacity-75"}>
            Login
        </button>
        <button className={"text-amber-500 underline underline-offset-4 self-end hover:opacity-75"}>
            <Link href={'signup'}>
                Go to Sign Up
            </Link>
        </button>
